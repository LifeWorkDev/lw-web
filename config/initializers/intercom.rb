IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = Rails.application.credentials.intercom&.dig(:id)
  ...
  #
  config.api_secret = Rails.application.credentials.intercom&.dig(:secret)
  ...
  #
  config.user.current = proc { true_user }
